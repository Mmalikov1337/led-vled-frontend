...
export const tempDeliveryData = [
	new DeliveryDataDTO("SDEK_point", 320),
	new DeliveryDataDTO("SDEK_door", 440),
	new DeliveryDataDTO("DPD_door", 320),
	new DeliveryDataDTO("DPD_point", 235),
	new DeliveryDataDTO("courier_omsk", 300),
	new DeliveryDataDTO("russian_post", 544),
];
...
export const tempProducts = [
	{
		...
		image: prod_1_2PNG,
		secondatyImage: [
			{ pic: lemon_2, styles: { width: "270px", height: "270px", right: "80px", top: "65px" } },
		],
		...
		layerOptions: [
			{
				parallaxCoefficientX: 1,
				parallaxCoefficientY: 1,
				layerStyle: {},
				bgItems: [
					{
						pic: ice_cube_1,
	...
	},
	{
		...
		image: prod_1_1PNG,
		secondatyImage: [
			{ pic: cherry2_3, styles: { width: "139px", height: "auto", top: "30px", right: "10%" } },
	...
	},
	{
		...
		image: prod_1_4PNG,
		secondatyImage: [
			{ pic: peach1, styles: { width: "250px", height: "250px", right: "175px", top: "54px" } },
		],
