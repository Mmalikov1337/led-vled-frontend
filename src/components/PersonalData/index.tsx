			...
			<div className="personal__container">
				...
				<section className="personal__section">
					<p>
						...
						персональных данных Викжановича Вячеслава Олеговича (далее – Оператор)
					</p>
					<p>
					...
					<p>
						...
						веб-сайта{" "}
						<a href="https://krisl.ru" className="link">
							https://krisl.ru
						</a>
					</p>
				</section>
				...
				<div className="personal__subtitle">
					<h4>
						<span>1.</span> Цели обработки персональных данных
					</h4>
				</div>
				<section className="personal__section">
					<p>
						Цель обработки персональных данных Пользователя — информирование Пользователя
						посредством отправки электронных писем; информирование Пользователя посредством
						телефонного звонка
					</p>
					<p>
				...
				<section className="personal__section">
					...
					<p>
						...
						Оператора hello@krisl.ru с пометкой «Актуализация персональных данных»
					</p>
					<p>
						...
						уведомление посредством электронной почты на электронный адрес Оператора hello@krisl.ru
				...
				<section className="personal__section">
					...
					<p>
						...
						<a href="https://krisl.ru/policy/" className="link">
							https://krisl.ru/policy/
						</a>
					</p>
				</section>
			</div>
