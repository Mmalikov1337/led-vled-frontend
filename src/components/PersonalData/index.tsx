			...
			<div className="personal__container">
				...
				<section className="personal__section">
					<p>
						...
						персональных данных, предпринимаемые ООО "Глобал" (далее – Оператор).
					</p>
					<p>
						Настоящая политика обработки персональных данных составлена в соответствии с
						требованиями Федерального закона от 27.07.2006. №152-ФЗ «О персональных данных» и
				...
				<section className="personal__section">
					...
					<p>
						3.5. Также на сайте происходит сбор и обработка обезличенных данных о посетителях (в
						т.ч. файлов «cookie») с помощью сервисов интернет-статистики (Яндекс Метрика и Гугл
						Аналитика и других).
					</p>
					<p>
						3.6. Вышеперечисленные данные далее по тексту Политики объединены общим понятием
						Персональные данные.
					</p>
				</section>
				...
				<section className="personal__section">
					...
					<p>
						4.2Также Оператор имеет право направлять Пользователю уведомления о новых продуктах и
						...
						электронной почты{" "}
						<a href="mailto:hello@ledvled.ru" className="link">
							hello@ledvled.ru
						</a>{" "}
				...
				<section className="personal__section">
					...
					<p>
						...
						адресу https://ledvled.ru/privacy-policy/.
					</p>
				</section>
			</div>
		</div>
